/***************************************************************************//**
* \file psoc4200M_config.h
*
* \brief
* PSoC4200M device configuration header
*
********************************************************************************
* \copyright
...
#ifndef _PSOC4200M_CONFIG_H_
#define _PSOC4200M_CONFIG_H_

/* Clock Connections */
typedef enum
{
    PCLK_IMOSS_CLOCK                = 0x0000u,  /* imo.clock */
    ...
    PCLK_CSD0_CLOCKS0               = 0x0006u,  /* csd[0].clocks[0] */
    PCLK_CSD0_CLOCKS1               = 0x0007u,  /* csd[0].clocks[1] */
    PCLK_CSD1_CLOCKS0               = 0x0008u,  /* csd[1].clocks[0] */
    PCLK_CSD1_CLOCKS1               = 0x0009u,  /* csd[1].clocks[1] */
    PCLK_SAR_CLOCK                  = 0x000Au,  /* sar.clock */
